...
def get_extensions():
    ...
    ext_experimental_c = Extension(
        ...
        [os.path.join(
         ...
         os.path.join(
            root, 'mlprodict/testing/experimental_c_impl/experimental_c_bench.cpp')],
        extra_compile_args=extra_compile_args,
        extra_link_args=extra_link_args,
        include_dirs=[
            # Path to pybind11 headers
    ...
    ext_murmurhash3 = Extension(
        'mlprodict.onnxrt.ops_cpu.op_murmurhash3_',
        [os.path.join(
            root, 'mlprodict/onnxrt/ops_cpu/op_murmurhash3_.cpp')],
        extra_compile_args=extra_compile_args,
        extra_link_args=extra_link_args,
        include_dirs=[
            # Path to pybind11 headers
