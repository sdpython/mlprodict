...
.. blogpost::
    ...
    I then modified the script to compare this outcome to what
    ...
    Both version spend similar time into the functions
    which computes the predictions but :epkg:`joblib` is
