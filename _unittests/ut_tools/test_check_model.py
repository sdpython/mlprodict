...
import onnx.onnx_cpp2py_export.checker as C  # pylint: disable=E0611,E0401
import onnx.defs
...
def checker_check_model(model, full_check=True):
    exc = None
    exc2 = None
    try:
...
class TestCheckModel(ExtTestCase):
    ...
    def _sample_float_tensor(self) -> TensorProto:
        np_array = numpy.random.randn(2, 3).astype(numpy.float32)
    ...
    def test_check_graph_types(self) -> None:
        ...
        # when checker_check_model is called with full_check=True
    ...
    def test_check_serialized_model(self) -> None:
        ...
        checker_check_model(model.SerializeToString())
    ...
    def _sample_0_elem_tensor(self) -> TensorProto:
        np_array = numpy.random.randn(0, 3).astype(numpy.float32)
        return helper.make_tensor(
            name='test',
            data_type=TensorProto.FLOAT,
            dims=(0, 3),
    ...
    def test_loop_with_same_initializer_input_below_ir4(self) -> None:
        ...
        checker_check_model(model, full_check=True)
